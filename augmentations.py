...
def aug_train(jpeg, grayscale, bdr, TrainAUG, low_pass, ds_name):
...
def aug_test(ISS_both_train_test, jpeg, grayscale, bdr, ds_name):
    ...
    if 'cifar' in ds_name:
        transform_test.transforms.append(transforms.Resize([32,32]))
    else:
