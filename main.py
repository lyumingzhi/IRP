...
parser.add_argument('--ds_name', default='cifar', help='type of dataset')
...
transform_train = aug_train(args.jpeg, args.grayscale, args.bdr, args.TrainAUG, args.lowpass, args.ds_name)
transform_test = aug_test(args.ISS_both_train_test, args.jpeg, args.grayscale, args.bdr, args.ds_name)
